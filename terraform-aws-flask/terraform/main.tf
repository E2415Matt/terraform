...
related to deploying the application in elastic container service (ECS)
*/

# random string for flask secret-key environment variable
...
# flask postgres target group's work load regulated
# by application load balancer defined below
